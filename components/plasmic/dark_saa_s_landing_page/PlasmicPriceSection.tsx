...
import sty from "./PlasmicPriceSection.module.css"; // plasmic-import: ahNE6p1tck6O/css
  ...
  return (
    ...
    >
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__c3Ip)}
      >
        <div className={classNames(projectcss.all, sty.freeBox__hTfRf)}>
          <PriceCard
            borders={["flatLeft"]}
            className={classNames("__wab_instance", sty.priceCard__qrC7)}
          />
        </div>
        <div className={classNames(projectcss.all, sty.freeBox__cw1Lx)}>
          <div className={classNames(projectcss.all, sty.freeBox__hMyd8)}>
            <div
          ...
          <PriceCard
            borders={["flatCenter"]}
            className={classNames("__wab_instance", sty.priceCard___2J1C5)}
          />
        </div>
        <div className={classNames(projectcss.all, sty.freeBox___4MPu)}>
          <PriceCard
            borders={
            ...
            className={classNames("__wab_instance", sty.priceCard__znnA3)}
          />
        </div>
      </Stack__>
    </div>

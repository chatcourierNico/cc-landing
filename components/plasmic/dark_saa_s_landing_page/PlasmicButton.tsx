...
import sty from "./PlasmicButton.module.css"; // plasmic-import: fciyd94IYsUr/css
    ...
    >
      ...
      {(
        ...
        ? renderPlasmicSlot({
            defaultContents: (
              <svg
                className={classNames(projectcss.all, sty.svg__rwolF)}
                role={"img"}
              />
            ),
      ...
      {(
        ...
        ? renderPlasmicSlot({
            defaultContents: (
              <svg
                className={classNames(projectcss.all, sty.svg__gm9Ph)}
                role={"img"}
              />
            ),
